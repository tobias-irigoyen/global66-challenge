...
<template>
  ...
  >
    ...
    <div class="relative rounded-lg bg-no-repeat bg-center bg-[length:90%] h-[102px] w-[126px]" :class="theme.badge">
      <FavButton
        :pokemon="pokemon"
        class="absolute !right-[5px] top-[5px] z-20"
      />
      <div class="relative z-10 w-[126px] h-[102px] flex items-center justify-center">
        <div
